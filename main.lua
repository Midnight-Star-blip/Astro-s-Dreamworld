...
VisualsTab:CreateSection("Opciones del Menú")
VisualsTab:CreateButton("Limpiar Todos los ESPs", function()
	clearESP()
end)

VisualsTab:CreateButton("Cerrar Interfaz por Completo", function()
	clearESP() 
	Ventana.ScreenGui:Destroy()
end)
